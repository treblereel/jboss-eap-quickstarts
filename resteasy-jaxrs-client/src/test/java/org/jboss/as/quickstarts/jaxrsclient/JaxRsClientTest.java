 ...
 */
package test.java.org.jboss.as.quickstarts.jaxrsclient;
...
/**
 * JUnit4 Test class which makes a request to the RESTful helloworld-rs web
 * service.
 * 
...
public class JaxRsClientTest {
	...
	public static void beforeClass() {
		JaxRsClientTest.XML_URL = System
				.getProperty(JaxRsClientTest.XML_PROPERTY);
		JaxRsClientTest.JSON_URL = System
				.getProperty(JaxRsClientTest.JSON_PROPERTY);
	}
	...
	public void test() {
		assertEquals("XML Response", JaxRsClientTest.XML_RESPONSE,
				this.runRequest(JaxRsClientTest.XML_URL,
						MediaType.APPLICATION_XML_TYPE));

		assertEquals("JSON Response", JaxRsClientTest.JSON_RESPONSE,
				this.runRequest(JaxRsClientTest.JSON_URL,
	 ...
	 * @param mediaType
	 *            The mediatype of the RESTful service
	 */
